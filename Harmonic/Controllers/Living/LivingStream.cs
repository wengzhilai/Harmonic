...
namespace Harmonic.Controllers.Living
{
    public class LivingStream : NetStream
    {
        ...
        /// 添加推送客户端
        /// </summary>
        /// <param name="publishingName"></param>
        /// <param name="publishingType"></param>
        /// <param name="pwd">密码</param>
        [RpcMethod(Name = "publish")]
        public void Publish([FromOptionalArgument] string publishingName, [FromOptionalArgument] string publishingType, [FromOptionalArgument] string pwd )
        {
